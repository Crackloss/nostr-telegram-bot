...
class _MethodPreservingRedirectHandler(urllib.request.HTTPRedirectHandler):
    """Manejador de redirecciones que preserva el método HTTP original (PUT, POST, etc.)
    urllib por defecto convierte PUT→GET en redirects 307/308, rompiendo la GitHub API."""
...
def _make_opener():
    """Devuelve un opener con el manejador de redirecciones correcto."""
    return urllib.request.build_opener(_MethodPreservingRedirectHandler)
